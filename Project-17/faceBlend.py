...
def normalizeImagesAndLandmarks(outSize, imIn, pointsIn):
  ...
  if len(pointsIn) == 68:
    ...
    raise Exception('other that 5/68 point detector not supported, found :{} points', len(pointsIn))

  leftEyeLeftCorner = (pointsIn[left_eye_pos].x, pointsIn[left_eye_pos].y)
  rightEyeRightCorner = (pointsIn[right_eye_pos].x, pointsIn[right_eye_pos].y)

  eyecornerSrc = leftEyeLeftCorner, rightEyeRightCorner 
